<template>
  <div>
    <el-tabs type="border-card">
      <el-tab-pane v-if="shouldHide('second')">
        <span slot="label">
      ...
      <el-tab-pane v-if="shouldHide('min')">
        <span slot="label">
          <i class="el-icon-date"></i>
          分
        </span>
      ...
      <el-tab-pane v-if="shouldHide('hour')">
        <span slot="label">
          <i class="el-icon-date"></i>
          时
        </span>
      ...
      <el-tab-pane v-if="shouldHide('day')">
        <span slot="label">
          <i class="el-icon-date"></i>
          日
        </span>
      ...
      <el-tab-pane v-if="shouldHide('mouth')">
        <span slot="label">
          <i class="el-icon-date"></i>
          月
        </span>
      ...
      <el-tab-pane v-if="shouldHide('week')">
        <span slot="label">
          <i class="el-icon-date"></i>
          周
        </span>
      ...
      <el-tab-pane v-if="shouldHide('year')">
        <span slot="label">
          <i class="el-icon-date"></i>
          年
        </span>
